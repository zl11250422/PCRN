...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    #folder_path = 'H:\VOCCrop\Flickr2K\Flickr2K\Flickr2K_HR'
    #lmdb_path = 'H:\VOCCrop\Flickr2K\Flickr2K\Flickr2K_HR.lmdb'
    ...
    # LRx4 images
    folder_path = 'H:\VOCCrop\Flickr2K\Flickr2K\Flickr2K_LR_bicubic\X2'
    lmdb_path = 'H:\VOCCrop\Flickr2K\Flickr2K\Flickr2K_LR_bicubic\X2.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
if __name__ == '__main__':
    ...
    #python create_lmdb.py --dataset DIV2K
    if dataset == 'div2k':
